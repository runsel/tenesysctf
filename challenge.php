      ...
      <div class="row"> 
        <div class="col-lg-8"> 
          <div class="panel-group panel-group-joined" id="accordion-test"> 
            <?php
              $select =  mysql_query("SELECT * from player where id_player='$_SESSION[id]' ");
              $dtuser = mysql_fetch_array($select);
              ...
              <div class="panel-heading"> 
                <h4 class="panel-title"> 
                  <a data-toggle="collapse" data-parent="#accordion-test" href="#misc" class="collapsed">
                    <i class="md-now-widgets"></i>  Miscellaneous
                  </a> 
                </h4> 
              </div> 
              <div id="misc" class="panel-collapse collapse"> 
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Misc' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
                      } else {
                      $m = 1;
                      while ($mission = mysql_fetch_array($chall)) {
                            $solve_check = "";
                        for ($i=1; $i< $count; $i++) { 
            ...
            <div class="panel panel-default panel-fill"> 
              ...
              <div id="forensic" class="panel-collapse collapse"> 
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Forensic' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
            ...
            <div class="panel panel-default panel-fill"> 
              ...
              <div id="crypto" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Crypto' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
			 ...
			 <div class="panel panel-default panel-fill"> 
              ...
              <div id="recon" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Recon' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
            ...
            <div class="panel panel-default panel-fill"> 
              ...
              <div id="web" class="panel-collapse collapse"> 
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Web' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
            ...
            <div class="panel panel-default panel-fill"> 
              <div class="panel-heading"> 
                <h4 class="panel-title"> 
                  <a data-toggle="collapse" data-parent="#accordion-test" href="#reverse" class="collapsed">
                    <i class="md-security"></i>  Reverse Enginering
                  </a> 
                </h4> 
              </div> 
              <div id="reverse" class="panel-collapse collapse"> 
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Reverse' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
		  ...
		  <div class="panel panel-default panel-fill"> 
              <div class="panel-heading"> 
                <h4 class="panel-title"> 
                  <a data-toggle="collapse" data-parent="#accordion-test" href="#pwn" class="collapsed">
                    <i class="md-flash-on"></i>  Pwn Exploitation
                  </a> 
                </h4> 
              </div> 
              <div id="pwn" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="list-group" style="margin: -20px;">
                    <?php
                      $chall = mysql_query("SELECT * from mission where kategori='Pwn' && display='1' order by id_soal asc ");
                      $check = mysql_num_rows($chall);
                      if ($check < 1) {
                        echo
                        "<div style='margin:20px;'><h5>Maaf belum ada soal yang dapat ditampilkan.</h5></div>";
