        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <?php
                $user = mysql_query("SELECT * FROM player where id_player='$_SESSION[id]' ");
              ...
              <table class="table table-striped">
                ...
                <?php
                  ...
                  $soal = $pecah[$i];
                  $qry=mysql_query( "SELECT * from mission where id_soal='$soal' ");
                  $n=1;
                  ...
                  $qry2 = mysql_query("SELECT * from lastsolved where username='$_SESSION[user]' AND id_soal='$soal' ");
                  $fetch2 = mysql_fetch_array($qry2)
