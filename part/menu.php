  ...
  <div class="sidebar-inner slimscrollleft">
    ...
    <div id="sidebar-menu">
      <ul>
		...
		<li>
          <a href="explanation.php" class="waves-effect"><i class="md-check-box"></i><span> Explanation </span></a>
        </li>
        <li>
          <a href="info.php" class="waves-effect"><i class="md-info"></i><span> Information </span></a>
        </li>
